...
2) добавить возможность редактировать информации о сотруднике, то есть сразу вытекает запрос к контейнеру,
...
Changes 06.08.18
1) поправил добавление нового сотрудника: теперь заполняются таблицы и листы менеджер и эксперт (в соответствии с типом аккаунта)
2) добавлена возможность изменения информации о сотруднике
